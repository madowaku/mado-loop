...
- worker provider calls and swarm calls are optional and are not part of deterministic release proof. CI unit tests validate selection, sensitivity, concurrency, failure isolation, deterministic fan-in ordering, and proof-authority invariants without making billable or logged external model calls.
